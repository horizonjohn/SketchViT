    ...
    def evaluate_RL(self, step_stddev):
        ...
        for i_batch, sanpled_batch in enumerate(self.Sketch_Array_Test):
            ...
            for i_sketch in range(sanpled_batch.shape[0]):
                _, sketch_feature, _, _ = self.policy_network.select_action(
                    sanpled_batch[i_sketch].unsqueeze(0).to(device))
        ...
        return round(top1_accuracy*100, 5), round(top5_accuracy*100, 5), round(top10_accuracy*100, 5), meanIOU
