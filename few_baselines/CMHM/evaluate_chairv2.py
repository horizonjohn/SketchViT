...
def Evaluate_chairv2(model, device):
    ...
    test_opt.coordinate = './ChairV2/ChairV2_Coordinate'
    ...
    # print('Test Accuracy: {:0.5f}/{:0.5f}/{:0.5f}\n'.format(top1, top5, top10), '-' * 50)

    return round(top1 * 100, 5), round(top5 * 100, 5), round(top10 * 100, 5)
...
if __name__ == "__main__":
    ...
    top1, top5, top10 = Evaluate_chairv2(model, device=torch.device('cuda'))
